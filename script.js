...
if (a) {
  ...
  // labelDate.textContent = `${day}/${mouth}/${year}, ${hour}:${min}`;
...
btnLoan.addEventListener('click', function (e) {
  ...
  const number = inputLoanAmount.value - 1;
...
// Binary base 2-0.1
console.log(0.1 + 0.2);
console.log(0.1 + 0.2 === 0.3); //should ouput false
...
*/
// const b = Array.from({ length: 1000 }, (_, i) => randomInt(0, 2)).filter(
//   mov => mov > 1
// ).length;
// console.log(b);
/*
...
console.log(Math.ceil(23.44444));
...
// Roundding decimals
console.log((2.7).toFixed(0)); //output type string
...
labelBalance.addEventListener(`click`, function (params) {
...
const PI = 3.1415; // 3._14151 or 3.1415_ output error
console.log(PI); // _ will only work between numbers
...
console.log(48634561231564311461321541321541313432n);
console.log(BigInt(48634561231564311461321541321541313432));

// Operations
console.log(10000n + 10000n);
console.log(35456486543214564561564n * 153123152315623n);

const huge = 203151615615615615n;
const num = 23;
...
console.log(new Date(2021, 9, 30, 15));
...
/*
// SetTimeout
const ingredients = [`olives`, `spinach`, `das`];

const pizzaTimer = setTimeout(
  (in1, in2) => console.log(`Here is your pizza ${in1} and ${in2}🎈`),
  3000,
  ...ingredients
);
